...
El primer proyecto integrador será el **Proyecto Banco**. Todos los
grupos recibirán el mismo problema y trabajarán durante **5 iteraciones
semanales**. Cada grupo tendrá un repositorio privado independiente, por
lo que no podrá consultar las soluciones de los demás grupos.
...
Orientada a Objetos**. Por esta razón, el trabajo no se dividirá
inicialmente en funcionalidades diferentes para cada estudiante.

En cada iteración:

1. cada integrante desarrollará **la iteración completa** en su propia
   rama;
2. publicará avances mediante commits frecuentes;
3. una vez terminada la etapa individual, el grupo comparará las
   soluciones;
4. el grupo discutirá las decisiones de diseño;
5. construirá una versión integrada en una rama de integración;
6. esa versión se incorporará a `main` mediante un Pull Request.
...
Las ramas individuales **no significan que cada estudiante haga una
parte distinta**: cada estudiante debe resolver la iteración completa.
...
La conformación y registro de los grupos se realizará según las
instrucciones indicadas por la cátedra.
...
Encontrarás el **MANUAL DE PROGRAMACIÓN 2**, donde:
