# ENUNCIADO 9
# Función acceder_dato(diccionario, clave) que devuelva el valor si la clave existe, o el string "[dato faltante]" si no. Usá try/except KeyError (después probá con .get() y explicá cuál es mejor).
